  ...
  render() {
    return (
      <div>
        ...
        <Dialog
          onExited={() => this.setState({ showSnackbar: true, isLoading : true })}
          fullScreen
        ...
        >
            ...
            <Grid container justify='center'>
              <Grid item xs={5}>
                ...
                <Button onClick={() => {
                  ...
                  this.props.addEntry(this.generateEntry());
                  if (!this.props.creatingEntry) {
                    this.closeDialog()
          ...
          : <CircularProgress variant={this.state.isLoading ? 'indeterminate' : 'determinate'} /> }
        </Dialog>
...
const mapStateToProps = state => ({
  ...
  creatingEntry: state.entries.creatingEntry
})
