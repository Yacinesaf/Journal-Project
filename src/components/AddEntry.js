...
import { Grid, Typography, Button, Dialog, DialogContent, TextField, TextareaAutosize, IconButton, Snackbar } from '@material-ui/core';
  ...
  render() {
    return (
      <div>
        ...
        <Dialog
          onExited={() => this.setState({showSnackbar : true})}
          fullScreen
