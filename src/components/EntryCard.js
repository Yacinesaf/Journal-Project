      ...
      <div style={{backgroundColor : 'rgba(0,0,0,.3)'}}>
        <div style={{ display: 'flex', padding: 20 }}>
          <div>
            ...
            <Typography variant='caption' style={{ color: 'white', display: 'block', fontWeight: 500, textShadow: '3px 3px 0px rgba(0,0,0,0.2)' }} >{object.date.month}</Typography>
        ...
        <div style={{ height: 'calc(400px - 150px)', display: 'flex', alignItems: 'flex-end', padding: 20, }}>
          <Typography style={{ color: 'white', fontWeight: 500, textOverflow: 'ellipsis' }} >{object.title ? object.title : 'No title'}</Typography>
        </div>
